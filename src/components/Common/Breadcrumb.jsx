...
const Breadcrumb = ({
  ...
  return (
    <>
      <div className="dark:bg-dark relative z-10 overflow-hidden pb-[100px] pt-[120px] md:pt-[130px] lg:pt-[100px]">
          ...
          <div className="-mx-4 flex flex-wrap items-center">
            <div className="w-full px-4">
              <div className="text-center">
                <h1 className="text-dark mb-4 text-3xl font-bold dark:text-white sm:text-4xl md:text-[52px] md:leading-[1.2]">
                  {pageName}
                </h1>
