...
const Footer = () => {
  return (
    <footer
      ...
      bg-[#00a6ac59] pt-20 lg:pt-[100px] xl:px-20 z-[999] "
      data-wow-delay=".15s"
    >
      <div className="">
        <div className=" grid grid-cols-1 lg:grid-cols-3 justify-between items-start">
          ...
          <div className="w-full pl-5 mb-10">
            ...
            <p className="mb-8 text-base font-medium text-black w-[80%] xl:w-3/4">
          ...
          <div className="w-full pl-5 xl:pl-24">
          ...
          <div className="w-full pl-5 xl:pl-12">
            <div className="flex items-center space-x-5">
            ...
            <nav className="pt-10 space-y-5 ">
              ...
              <li className="flex items-start">
                ...
                <div className=" flex flex-col  items-start justify-center ml-5">
                  ...
                  <p className="text-[#000000ab] font-medium w-[80%]">B-133 and 135, 1st Floor, Safal Sumel 8 Business Park, Nr Ajit Mill Cross Rd, Opp City Point Hotel, Rakhiyal, Ahmedabad, Gujarat 380023.</p>
                </div>
              </li>
            </nav>
          </div>
            ...
            <div className="w-full px-4 md:w-2/3 lg:w-1/2">
              <div className="my-1">
                <div className="-mx-3 flex items-center justify-center md:justify-start">
                  <Link
                    href="/#"
                    className="px-3 text-xs lg:text-base text-[#000000ab] hover:text-white hover:underline"
                  >
                    Privacy policy
                  </Link>
                  <Link
