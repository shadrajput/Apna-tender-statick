      ...
      <div className="items-center w-full ">
        ...
        <div className="flex items-center flex-col justify-center">
            ...
            <div className="flex items-center flex-col justify-center">
              <div className="relative group flex flex-col justify-center items-center h-32 w-32 xl:h-48 xl:w-48 border border-[#00a6ac47] rounded-full">
                <div className="w-24 h-24 xl:w-36 xl:h-36 bg-[#00a6ac32] group-hover:bg-[#00a7ac] group-hover:-translate-y-2 duration-300 rounded-full flex items-center justify-center ">
                  <IoBulbOutline className="text-4xl xl:text-6xl group-hover:text-white duration-300 text-[#00a7ac]" />
                </div>
                <div className="bg-[#000000] rounded-full h-10 w-10 xl:h-14 xl:w-14 flex justify-center items-center text-white font-semibold text-lg absolute top-0 right-0">
                  02
                </div>
              </div>
              <h1 className="text-lg xl:text-xl font-semibold mt-3 xl:mt-10">Strategy Formulation</h1>
              <p className="text-center text-xs sm:text-sm xl:w-2/3">Then craft a customised tender strategy.</p>
            </div>

            <div className="flex items-center flex-col justify-center">
              <div className="relative group flex flex-col justify-center items-center h-32 w-32 xl:h-48 xl:w-48 border border-[#00a6ac47] rounded-full">
                <div className="w-24 h-24 xl:w-36 xl:h-36 bg-[#00a6ac32] group-hover:bg-[#00a7ac] group-hover:-translate-y-2 duration-300 rounded-full flex items-center justify-center ">
                  <IoSettingsOutline className="text-4xl xl:text-6xl group-hover:text-white duration-300 text-[#00a7ac]" />
                </div>
                <div className="bg-[#000000] rounded-full h-10 w-10 xl:h-14 xl:w-14 flex justify-center items-center text-white font-semibold text-lg absolute top-0 right-0">
                  03
                </div>
              </div>
              <h1 className="text-lg xl:text-xl font-semibold mt-3 xl:mt-10">Implementation</h1>
              <p className="text-center text-xs sm:text-sm xl:w-2/3">Strive to execute the strategy with precision.</p>
            </div>
            
            <div className="flex items-center flex-col justify-center">
              <div className="relative group flex flex-col justify-center items-center h-32 w-32 xl:h-48 xl:w-48 border border-[#00a6ac47] rounded-full">
                <div className="w-24 h-24 xl:w-36 xl:h-36 bg-[#00a6ac32] group-hover:bg-[#00a7ac] group-hover:-translate-y-2 duration-300 rounded-full flex items-center justify-center ">
                  <BsClipboard2Check className="text-4xl xl:text-6xl group-hover:text-white duration-300 text-[#00a7ac]" />
                </div>
                <div className="bg-[#000000] rounded-full h-10 w-10 xl:h-14 xl:w-14 flex justify-center items-center text-white font-semibold text-lg absolute top-0 right-0">
                  04
                </div>
              </div>
              <h1 className="text-lg xl:text-xl font-semibold mt-3 xl:mt-10">Result Analysis</h1>
              <p className="text-center text-xs sm:text-sm xl:w-2/3">Finally, monitor and give feedback for continuous improvement.</p>
            </div>
