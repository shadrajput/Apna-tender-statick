    ...
    <div className="w-full px-4 md:w-1/2 lg:w-1/3">
      ...
      >
        {product.nickname === "Premium" && (
          <p className="absolute right-[-50px] top-[60px] inline-block -rotate-90 rounded-bl-md rounded-tl-md bg-[#156C83] px-5 py-2 text-base font-medium text-white">
            Recommended
          </p>
        )}
        ...
        <div className="w-full">
          <button
            ...
            className="inline-block rounded-md bg-[#156C83] px-7 py-3 text-center text-base font-medium text-white transition duration-300 hover:bg-[#156C83]/90"
          >
            Purchase Now
          </button>
        </div>
