...
const Header = () => {
  ...
  return (
    <>
      ...
      <div className="h-10 bg-[#00a7ac] flex justify-between items-center w-full px-20 py-6 ">
      ...
      <header
        className={`ud-header z-40  top-0 flex w-full items-center px-20 relative ${sticky
        ...
        <div className="container">
          <div className="relative -mx-4 flex items-center justify-between">
            <div className="w-44 max-w-full">
              <Link
                href="/"
                className={`navbar-logo block w-full ${sticky ? "py-3" : "py-4"
                  } `}
              >
                {pathUrl !== "/" ? (
                  <>
              ...
              {token ? (
                ...
                <div>
                  <button onClick={() => setInquiry(true)}
                    className="rounded-md px-6 text-white font-semibold border-[#00a7ac] py-[10px] bg-[#00a7ac] border-2 hover:bg-transparent hover:border-[#00a7ac] hover:text-[#00a7ac] duration-500">
