...
const RecentTender = () => {
  ...
  return (
    <section className=" recenttender p-20 mt-10 bg-[#f8f8f8] overflow-hidden">
      <div className=" flex items-center justify-between w-full">
        <div className="space-y-3">
          <h2 className="text-4xl font-bold font">
            Recent <span className="text-[#00a7ac]">Tender</span> List
          </h2>
        ...
        <div className="flex items-center justify-center">
          <Link href="/tenders" className="flex items-center space-x-2 group">
            <button className="text-primary hover:underline duration-300 hover:text-[#00a7ac] font-medium">
              View All Tenders
            </button>
            <GoArrowRight className="group-hover:translate-x-2 text-lg duration-500 text-primary" />
          </Link>
        </div>
      </div>
