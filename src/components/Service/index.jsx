...
const Service = () => {
  return (
    <section
      id="services"
      className="tenderlist px-20 bg-[#ddf2f257] flex flex-col justify-center items-center py-20">
      <div className="space-y-3">
        <h2 className="text-[45px] font-bold font text-center">Explore the our <span className="text-[#00a7ac] ">Servicess</span></h2>
        <p className="text-center">To choose your trending job dream & to make future bright.</p>
      </div>

      <div className="flex justify-center mt-20 items-center w-full gap-10">
