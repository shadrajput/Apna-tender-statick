...
const TenderCard = ({ Data, resultId, itemsPerPage, setPageNo, pageCount }) => {
    ...
    const { id, apna_tender_id, description, estimated_value, state, title, closing_date, opening_date, department, isBookmarked, isApplied } = Data;
    let tender_id = id
    ...
    return (
        <>
            <div className="w-full pt-5 pb-5 px-7 flex flex-col bg-white justify-between mb-8  border rounded-3xl shadow-md shadow-[#00a6ac0f] hover:shadow-none hover:border-[#00a7ac] duration-300">
                ...
                <div className="flex items-center justify-between w-full">
                    <div className="w-[80%] flex ">
                        <div className="w-[70%]" >
                            ...
                            <h3 className="text-gray-600 mt-1">{description}</h3>
                            {
                                resultId ?
                                    ...
                                    :
                                    <div className="flex mt-3 items-center space-x-3 bg-red-100 p-2 w-[45%] justify-center rounded-md">
                    ...
                    <div className="w-[20%] items-end justify-between h-full space-y-2 pr-5  ">
