...
function AddAdminModal({showModal, handleShowModal, refetchAdminData}) {
  const [addAdmin, {...addingAdmin}]  = useAddAdminMutation();
          ...
          <div className="px-4 py-4">
            <form className="space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="mt-5 text-right">
                <button
                  type="submit"
                  disabled={addingAdmin.isLoading}
                  className={`${addingAdmin.isLoading ? 'opacity-60' : ''} w-28 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-3 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800`}
                >
                  {addingAdmin.isLoading ? 'Loading...' : 'Submit'}
                </button>
              </div>
            </form>
          </div>
